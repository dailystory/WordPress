...
class DailyStoryShortCodes {
	...
	public static function dailystory_webform_shortcode($atts, $content=null) {
		...
		wp_register_script('ds-landingpages', 'https://cms-1.dailystory.com/Scripts/ds-landingpages.js', array('jquery'),'1.1', true);
    	wp_register_script('ds-timezones', 'https://cms-1.dailystory.com/Scripts/detect_timezone.js', array('jquery'),'1.1', true);
		...
		// enqueue css
		wp_enqueue_style('ds-webform','https://cms-1.dailystory.com/Content/base_webform.css', null, '1.1', 'all');
		...
		// get the contents
		list($cc_result, $cc_error) = self::get_data('https://cms-1.dailystory.com/webform/iframe/' . $tenantuid . '/' . $webform_id);
