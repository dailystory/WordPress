...
### 2.1.6
* Paths update for CSS and JavaScript
...
### 2.1.1
* Support for redirect url in web form and new javascript events

### 2.0.6
* Minor updates to support minified CSS

### 2.0.5
* Updated dailystory.com paths
